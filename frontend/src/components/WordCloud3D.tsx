  ...
  const { positions, colors, whitePositions, whiteColors } = useMemo(() => {
    ...
    for (let i = 0; i < count; i++) {
      ...
      if (colorMix < 0.3) {
        ...
        colors[coloredCount * 3] = 0.5 + Math.random() * 0.5;
        colors[coloredCount * 3 + 1] = 0.7 + Math.random() * 0.3;
        colors[coloredCount * 3 + 2] = 1.0;
        coloredCount++;
      } else if (colorMix < 0.6) {
        positions[coloredCount * 3] = x;
        positions[coloredCount * 3 + 1] = y;
        positions[coloredCount * 3 + 2] = z;
        colors[coloredCount * 3] = 0.7 + Math.random() * 0.3;
        colors[coloredCount * 3 + 1] = 0.5 + Math.random() * 0.3;
        colors[coloredCount * 3 + 2] = 0.8 + Math.random() * 0.2;
        coloredCount++;
      } else {
